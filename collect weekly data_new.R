...
# clean data, isolate plays that start a drive, and create new columns for the 2021 season data which is used to see how the model is doing 
...
# create a separate table to calculate punt rate for each team's offense and defense year to date
...
# create a table for offensive and defensive efficiency year to date
...
# bring both punts and epa into the drive start table 
